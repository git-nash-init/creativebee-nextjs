        ...
        <div className="foot-grid">
          <div>
            ...
            <div className="socials">
              {socials.map(([label, cls, d]) => (
                <a href="#" aria-label={label} className={cls} key={label}>
